...
const PORTFOLIO_CONFIG: PortfolioConfig = {
  ...
  images: [
    ...Array.from({ length: 21 }, (_, i) => ({
      id: `nature-${i + 1}`,
      title: `Nature Moment ${i + 1}`,
      description: "Beautiful nature photography capturing the essence of the outdoors",
      src: `/portfolio/nature/image${i + 1}.jpg`,
      alt: `Nature photography image ${i + 1}`
    }))
  ]
};
// ============================================================
