...
const PORTFOLIO_CONFIG: PortfolioConfig = {
  ...
  images: [
    ...Array.from({ length: 15 }, (_, i) => ({
      id: `studio-${i + 1}`,
      title: `Studio Moment ${i + 1}`,
      description: "Beautiful studio photography capturing creativity and emotion",
      src: `/portfolio/studio/image${i + 1}.jpg`,
      alt: `Studio photography image ${i + 1}`
    }))
  ]
};
// ============================================================
