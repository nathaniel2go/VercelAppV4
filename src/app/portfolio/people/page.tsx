...
const PORTFOLIO_CONFIG = {
  ...
  images: [
    ...Array.from({ length: 20 }, (_, i) => ({
      id: `people-${i + 1}`,
      title: `People Moment ${i + 1}`,
      description: "Beautiful people photography capturing love and emotion",
      src: `/portfolio/people/image${i + 1}.jpg`,
      alt: `People photography image ${i + 1}`
    }))
  ]
};
// ============================================================
